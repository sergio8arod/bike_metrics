  ...
  <body>
    <nav class="navbar navbar-light bg-faded" style="background-color: #ededed; height: 50">
      ...
      <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #00854A; margin-bottom: 10px;">
          <a class="navbar-brand" href="<?php echo site_url('userInd/index'); ?>">
          ...
          <!-- <div class="container-fluid"> -->
              ...
              <div class="navbar-collapse collapse" id="bikeMetricsNav"> 
                  <ul class="navbar-nav mr-auto"> 
                      <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('userInd/index');?>">Indicadores</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('userModify/index');?>">Actualizar datos</a>
                            </li>
                  </ul>
        ...
        <form data-bind="submit: saveUser">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input data-bind="textInput: inputEmail" type="email" class="form-control" id="inputEmail" placeholder="Email" readonly>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input data-bind="textInput: inputName" type="text" class="form-control" id="inputName" placeholder="Nombre completo" >
                </div>
                <div class="form-group col-md-6">
                    <label for="inputIdentification">Identificación</label>
                    <input data-bind="textInput: inputIdentification" type="text" class="form-control" id="inputIdentification" placeholder="1030266xxx" >
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-5">
                    <label for="inputAddress">Dirección</label>
                    <input data-bind="textInput: inputAddress, event: {change: chgAddres}" type="text" class="form-control" id="inputAddress" placeholder="Cl. 71 # 17 - 39" required>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <select data-bind="value: inputClientID" class="form-control" id="inputEntity" style="height: 40px" readonly>
            ...
            <div data-bind="visible: divMap" class="form-group">
                <label for="map">Arrastra el marcador a tu nuevo lugar de residencia</label>
                <div id="map"></div>
    ...
    <script src="<?php echo base_url('js/userModify.js');?>"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
